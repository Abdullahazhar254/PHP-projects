                            ...
                            if(mysqli_num_rows($result) > 0){
                                    while($row = mysqli_fetch_array($result)){
                                        echo "<tr class=row100>";
                                            ...
                                            echo "<a href='batchupdate.php?id=". $row['b_id'] ."'  data-toggle='tooltip'> <img style=width:30px src=img/update.png </a> |";
                                            echo "<a href='batchdelete.php?id=". $row['b_id'] ."' data-toggle='tooltip'><img style=width:35px src=img/delete.jpg </a>";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                            } 
