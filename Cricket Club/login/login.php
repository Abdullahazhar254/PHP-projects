...
<body>
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<a href="../home.php"><img style="width:50px" src="../images/back.png" /></a>
					...
					<form action="login.php" method="post">
						...
						<input class="input100" type="text" name="username" required placeholder="Type your username">
					...
					<div class="flex-col-c p-t-155">
						...
						<a href="../packages.php" class="txt2">
							 Register Now
						</a>
						<br/>
  ...
  if (isset($_POST['login'])){
    ...
    $select="SELECT * FROM member WHERE m_username='$username' AND m_password='$password'";
